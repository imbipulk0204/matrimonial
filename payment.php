...
?>
        <!-- <h2>Refreshing the page will delete the cupon.</h2>
        <h3>*do not refresh the page until you save the cupon number</h3> -->
...
?>
    ...
    <h4 id="balance"><i style="color:green;font-size:25px" class="fa fa-money" aria-hidden="true"></i> <?php if($balance==0){
      echo "zero balance";
    } else echo $balance; ?></h4>
